...
const arrayNames = [ 'The Legend of Zelda: Ocarina of Time','Super Mario 64', 'Star Fox 64', 'Super Smash Bros', 'Banjo-Kazooie', 'Perfect Dark', 'GoldenEye 007','Kirby 64: The Crystal Shards']

const getDetails = (name) => {
    request
    .get(`https://api-endpoint.igdb.com/games/?search=${name}`)
          .set({'user-key': '819d91b1e002bd11047acc3dbba1b7f9',accept: 'application/json', 
        ...
        //     return res})
        .then(res => add(JSON.parse(res.body[0].id)))
        .then (arraykeys => handleObject (arrayKeys))
...
const getObject = (key) => {
    ...
    .get(`https://api-endpoint.igdb.com/games/${key}`)
        ...
        //    'Access-Control-Allow-Origin': '*', "Access-Control-Allow-Credentials" :'false' 
          ...
          .then(res => {console.log(res.body[0].name)
